 ...
 */
define('PSXCLK_CLOCK_REALTIME', 0);
 ...
 */
define('PSXCLK_CLOCK_MONOTONIC', 1);

/**
 * Per-process CPU-time clock (measures CPU time consumed by all threads in
 * the process).
 */
define('PSXCLK_CLOCK_PROCESS_CPUTIME_ID', 2);


/**
 * Thread-specific CPU-time clock.
 */
define('PSXCLK_CLOCK_THREAD_CPUTIME_ID', 3);
 ...
 */
define ('PSXCLK_CLOCK_BOOTTIME', 7);
 ...
 * @return float|string
 */
function posix_clock_gettime($clock_id = PSXCLK_CLOCK_REALTIME) {}
 ...
 * @return float
 */
function posix_clock_getres($clock_id = PSXCLK_CLOCK_REALTIME) {}
